...
func (r *ClusterTriggerAuthenticationReconciler) SetupWithManager(mgr ctrl.Manager) error {
	// WATCH_LABEL_SELECTOR_FOR_TRIGGERAUTH scopes this operator to ClusterTriggerAuthentications matching the selector.
	labelSelectorPredicate, err := util.WatchLabelSelectorForTriggerAuthPredicate()
	if err != nil {
		return err
	}
