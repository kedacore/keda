...
func (r *ScaledObjectReconciler) SetupWithManager(mgr ctrl.Manager, options controller.Options) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.ScaledObject{}, builder.WithPredicates(
			predicate.Or(
...
func (r *ScaledObjectReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		conditions.SetReadyCondition(metav1.ConditionTrue, v1alpha1.ScaledObjectConditionReadySucccesReason, msg)
	}
...
func (r *ScaledObjectReconciler) reconcileScaledObject(ctx context.Context, logger logr.Logger, scaledObject *v1alpha1.ScaledObject) (string, error) {
	...
	return v1alpha1.ScaledObjectConditionReadySuccessMessage, nil
}
...
func (r *ScaledObjectReconciler) ensureScaledObjectLabel(ctx context.Context, logger logr.Logger, scaledObject *v1alpha1.ScaledObject) error {
	if scaledObject.Labels == nil {
		scaledObject.Labels = map[string]string{v1alpha1.ScaledObjectOwnerAnnotation: scaledObject.Name}
	} else {
		value, found := scaledObject.Labels[v1alpha1.ScaledObjectOwnerAnnotation]
		if found && value == scaledObject.Name {
			return nil
		}
		scaledObject.Labels[v1alpha1.ScaledObjectOwnerAnnotation] = scaledObject.Name
	}
...
func (r *ScaledObjectReconciler) checkTargetResourceIsScalable(ctx context.Context, logger logr.Logger, scaledObject *v1alpha1.ScaledObject) (v1alpha1.GroupVersionKindResource, error) {
...
func (r *ScaledObjectReconciler) checkTriggers(scaledObject *v1alpha1.ScaledObject) error {
...
func (r *ScaledObjectReconciler) checkReplicaCountBoundsAreValid(scaledObject *v1alpha1.ScaledObject) error {
	min := int32(0)
...
func (r *ScaledObjectReconciler) ensureHPAForScaledObjectExists(ctx context.Context, logger logr.Logger, scaledObject *v1alpha1.ScaledObject, gvkr *v1alpha1.GroupVersionKindResource) (bool, error) {
	var hpaName string
...
func isHpaRenamed(scaledObject *v1alpha1.ScaledObject, foundHpa *autoscalingv2.HorizontalPodAutoscaler) bool {
...
func (r *ScaledObjectReconciler) requestScaleLoop(ctx context.Context, logger logr.Logger, scaledObject *v1alpha1.ScaledObject) error {
...
func (r *ScaledObjectReconciler) stopScaleLoop(ctx context.Context, logger logr.Logger, scaledObject *v1alpha1.ScaledObject) error {
	key, err := cache.MetaNamespaceKeyFunc(scaledObject)
	if err != nil {
		logger.Error(err, "Error getting key for scaledObject")
		return err
...
func (r *ScaledObjectReconciler) scaledObjectGenerationChanged(logger logr.Logger, scaledObject *v1alpha1.ScaledObject) (bool, error) {
	key, err := cache.MetaNamespaceKeyFunc(scaledObject)
	if err != nil {
		logger.Error(err, "Error getting key for scaledObject")
		return true, err
...
func (r *ScaledObjectReconciler) updatePromMetrics(scaledObject *v1alpha1.ScaledObject, namespacedName string) {
