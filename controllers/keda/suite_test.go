...
var _ = BeforeSuite(func() {
	...
	err = (&ScaledObjectReconciler{
		...
		ScaleHandler: scaling.NewScaleHandler(k8sManager.GetClient(), scaleClient, k8sManager.GetScheme(), time.Duration(10), 0, k8sManager.GetEventRecorder("keda-operator"), authClientSet),
