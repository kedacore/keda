...
func newDbo(rootSDK *Swo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Dbo {
	return &Dbo{
		rootSDK:          rootSDK,
...
func (s *Dbo) ObserveDatabase(ctx context.Context, request components.DboObserveDatabaseRequest, opts ...operations.Option) (*operations.ObserveDatabaseResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/dbo/databases")
	if err != nil {
	...
	res := &operations.ObserveDatabaseResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ObserveDatabaseResponseBody
...
func (s *Dbo) GetConfig(ctx context.Context, opts ...operations.Option) (*operations.GetConfigResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v1/dbo/databases/config")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Dbo) SetConfig(ctx context.Context, request []components.CommonKeyValuePair, opts ...operations.Option) (*operations.SetConfigResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.SetConfigResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Dbo) GetPublicKey(ctx context.Context, opts ...operations.Option) (*operations.GetPublicKeyResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v1/dbo/databases/credentials/public-key")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Dbo) DeleteDatabase(ctx context.Context, request operations.DeleteDatabaseRequest, opts ...operations.Option) (*operations.DeleteDatabaseResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/dbo/databases/{entityId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Dbo) UpdateDatabase(ctx context.Context, request operations.UpdateDatabaseRequest, opts ...operations.Option) (*operations.UpdateDatabaseResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Dbo) GetPluginConfig(ctx context.Context, request operations.GetPluginConfigRequest, opts ...operations.Option) (*operations.GetPluginConfigResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/dbo/databases/{entityId}/pluginConfig", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetPluginConfigResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Dbo) GetPlugins(ctx context.Context, request operations.GetPluginsRequest, opts ...operations.Option) (*operations.GetPluginsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/dbo/databases/{entityId}/plugins", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Dbo) PluginOperation(ctx context.Context, request operations.PluginOperationRequest, opts ...operations.Option) (*operations.PluginOperationResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/dbo/databases/{entityId}/plugins/operation/{operation}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.PluginOperationResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// UnobserveDatabase - Unobserve an observed database
func (s *Dbo) UnobserveDatabase(ctx context.Context, request operations.UnobserveDatabaseRequest, opts ...operations.Option) (*operations.UnobserveDatabaseResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/dbo/databases/{entityId}/unobserve", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.UnobserveDatabaseResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
