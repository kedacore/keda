...
// This package is purpose-built for metric attribute pruning. Only DROP_ATTRIBUTES_FROM_METRIC_AGGREGATES
// is supported here; DROP_ATTRIBUTES (event-scoped) and DROP_DATA (full data deletion) belong in the
// general-purpose nrqldroprules package and are intentionally excluded to prevent misuse.
