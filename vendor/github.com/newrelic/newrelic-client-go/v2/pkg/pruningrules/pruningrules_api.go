...
func (a *Pruningrules) NRQLDropRulesCreate(
	accountID int,
...
// Create new drop rule(s).
func (a *Pruningrules) NRQLDropRulesCreateWithContext(
	ctx context.Context,
	accountID int,
	rules []NRQLDropRulesCreateDropRuleInput,
) (*NRQLDropRulesCreateDropRuleResult, error) {
...
func (a *Pruningrules) NRQLDropRulesDelete(
	accountID int,
	ruleIds []string,
...
// Delete drop rule(s) by id.
func (a *Pruningrules) NRQLDropRulesDeleteWithContext(
	ctx context.Context,
	accountID int,
	ruleIds []string,
) (*NRQLDropRulesDeleteDropRuleResult, error) {
...
// List the drop rules for the given account
func (a *Pruningrules) GetListWithContext(
	ctx context.Context,
	accountID int,
) (*NRQLDropRulesListDropRulesResult, error) {
