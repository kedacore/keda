...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		v1beta1.ExternalMetricValue{}.OpenAPIModelName():     schema_pkg_apis_external_metrics_v1beta1_ExternalMetricValue(ref),
		v1beta1.ExternalMetricValueList{}.OpenAPIModelName(): schema_pkg_apis_external_metrics_v1beta1_ExternalMetricValueList(ref),
	}
}
...
func schema_pkg_apis_meta_v1_List(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1.ListMeta{}.OpenAPIModelName(), "k8s.io/apimachinery/pkg/runtime.RawExtension"},
	}
}
...
func schema_pkg_apis_meta_v1_TableRow(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1.TableRowCondition{}.OpenAPIModelName(), "k8s.io/apimachinery/pkg/runtime.RawExtension"},
	}
}
...
func schema_pkg_apis_external_metrics_v1beta1_ExternalMetricValue(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			resource.Quantity{}.OpenAPIModelName(), v1.Time{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_external_metrics_v1beta1_ExternalMetricValueList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1beta1.ExternalMetricValue{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1.ListMeta{}.OpenAPIModelName(), v1beta1.ExternalMetricValue{}.OpenAPIModelName()},
	}
}
