...
// Marshal an object of type ActivityExecutionAlreadyStartedFailure to the protobuf v3 wire format
func (val *ActivityExecutionAlreadyStartedFailure) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type ActivityExecutionAlreadyStartedFailure from the protobuf v3 wire format
func (val *ActivityExecutionAlreadyStartedFailure) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *ActivityExecutionAlreadyStartedFailure) Size() int {
	return proto.Size(val)
}

// Equal returns whether two ActivityExecutionAlreadyStartedFailure values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *ActivityExecutionAlreadyStartedFailure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *ActivityExecutionAlreadyStartedFailure
	switch t := that.(type) {
	case *ActivityExecutionAlreadyStartedFailure:
		that1 = t
	case ActivityExecutionAlreadyStartedFailure:
		that1 = &t
	default:
...
// Marshal an object of type NexusOperationExecutionAlreadyStartedFailure to the protobuf v3 wire format
func (val *NexusOperationExecutionAlreadyStartedFailure) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type NexusOperationExecutionAlreadyStartedFailure from the protobuf v3 wire format
func (val *NexusOperationExecutionAlreadyStartedFailure) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *NexusOperationExecutionAlreadyStartedFailure) Size() int {
	return proto.Size(val)
}

// Equal returns whether two NexusOperationExecutionAlreadyStartedFailure values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *NexusOperationExecutionAlreadyStartedFailure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *NexusOperationExecutionAlreadyStartedFailure
	switch t := that.(type) {
	case *NexusOperationExecutionAlreadyStartedFailure:
		that1 = t
	case NexusOperationExecutionAlreadyStartedFailure:
		that1 = &t
	default:
