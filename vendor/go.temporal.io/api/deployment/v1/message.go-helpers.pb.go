...
// Equal returns whether two InheritedAutoUpgradeInfo values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *InheritedAutoUpgradeInfo) Equal(that interface{}) bool {
	...
	var that1 *InheritedAutoUpgradeInfo
	switch t := that.(type) {
	case *InheritedAutoUpgradeInfo:
		that1 = t
	case InheritedAutoUpgradeInfo:
		that1 = &t
	default:
