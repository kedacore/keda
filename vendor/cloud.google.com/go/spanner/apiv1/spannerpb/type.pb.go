...
const file_google_spanner_v1_type_proto_rawDesc = "" +
	"\n" +
	"\x1cgoogle/spanner/v1/type.proto\x12\x11google.spanner.v1\x1a\x1fgoogle/api/field_behavior.proto\"\xb9\x02\n" +
	"\x04Type\x124\n" +
	"\x04code\x18\x01 \x01(\x0e2\x1b.google.spanner.v1.TypeCodeB\x03\xe0A\x02R\x04code\x12E\n" +
	"\x12array_element_type\x18\x02 \x01(\v2\x17.google.spanner.v1.TypeR\x10arrayElementType\x12>\n" +
	"\vstruct_type\x18\x03 \x01(\v2\x1d.google.spanner.v1.StructTypeR\n" +
	"structType\x12N\n" +
	"\x0ftype_annotation\x18\x04 \x01(\x0e2%.google.spanner.v1.TypeAnnotationCodeR\x0etypeAnnotation\x12$\n" +
	"\x0eproto_type_fqn\x18\x05 \x01(\tR\fprotoTypeFqn\"\x93\x01\n" +
	"\n" +
	"StructType\x12;\n" +
	"\x06fields\x18\x01 \x03(\v2#.google.spanner.v1.StructType.FieldR\x06fields\x1aH\n" +
	"\x05Field\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12+\n" +
	"\x04type\x18\x02 \x01(\v2\x17.google.spanner.v1.TypeR\x04type*\xdf\x01\n" +
	"\bTypeCode\x12\x19\n" +
	"\x15TYPE_CODE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04BOOL\x10\x01\x12\t\n" +
	"\x05INT64\x10\x02\x12\v\n" +
	"\aFLOAT64\x10\x03\x12\v\n" +
	"\aFLOAT32\x10\x0f\x12\r\n" +
	"\tTIMESTAMP\x10\x04\x12\b\n" +
	"\x04DATE\x10\x05\x12\n" +
	"\n" +
	...
	"\x12\b\n" +
	"\x04JSON\x10\v\x12\t\n" +
	"\x05PROTO\x10\r\x12\b\n" +
	"\x04ENUM\x10\x0e\x12\f\n" +
	"\bINTERVAL\x10\x10\x12\b\n" +
	"\x04UUID\x10\x11*d\n" +
	"\x12TypeAnnotationCode\x12$\n" +
	" TYPE_ANNOTATION_CODE_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"PG_NUMERIC\x10\x02\x12\f\n" +
	"\bPG_JSONB\x10\x03\x12\n" +
	"\n" +
...
func file_google_spanner_v1_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_spanner_v1_type_proto_rawDesc), len(file_google_spanner_v1_type_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
