...
- **General**: Fix panic in the HashiCorp Vault token renewal goroutine when the token cannot be renewed, which crashed the operator ([#7939](https://github.com/kedacore/keda/issues/7939))
