...
- **General**: Introduce a new operator argument `strict-cooldown-behavior` (defaults to false). When this argument is set to true, KEDA will honor HPA cooldown period before starts it owns cooldown in order to scale to zero.  ([#7204](https://github.com/kedacore/keda/issues/7204))
