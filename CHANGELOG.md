...
- **Azure Pipelines Scaler**: Add `scaleOnInFlight` trigger option (default `true`) so assigned jobs count towards queue length again, fixing ScaledJob and ScaledObject regressions after 2.20 ([#7878](https://github.com/kedacore/keda/issues/7878), [#8185](https://github.com/kedacore/keda/issues/8185))
