...
- **Azure Monitor Scaler**: Request the `FULL` interval so Azure returns a single aggregated data point for the whole timespan ([#7524](https://github.com/kedacore/keda/issues/7524))
