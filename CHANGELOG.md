...
- **General**: Update Fallback condition when health status changes between `HealthStatusHappy` and `HealthStatusFailing` ([#7488](https://github.com/kedacore/keda/issues/7488))
