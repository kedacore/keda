...
- **Metrics API Scaler**: Require ClusterTriggerAuthentication to provide URL when it supplies request credentials ([#7782](https://github.com/kedacore/keda/issues/7782))
