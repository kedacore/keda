...
- **GitHub Runner Scaler**: Fix '100 Jobs'-Hardlimit on GitHub Actions queue length by fetching additional pages. ([#7969](https://github.com/kedacore/keda/issues/7969))
