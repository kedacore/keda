...
- **Splunk Observability Scaler**: Add support for `sum`, `count`, and `latest` query aggregators for SLO-style queries ([#XXXX](https://github.com/kedacore/keda/issues/XXXX))
