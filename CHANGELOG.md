...
- `keda-operator` Cluster Role: add `list` and `watch` access to service accounts ([#2383](https://github.com/kedacore/keda/issues/2383))|([#2410](https://github.com/kedacore/keda/issues/2410))
