...
- **General:**: Add ScaledObject/ScaledJob Names when kubectl get triggerauthentication/clustertriggerauthentication([#796](https://github.com/kedacore/keda/issues/796))
