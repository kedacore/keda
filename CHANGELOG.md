...
- **Github Runner Scaler**: Fetch all pages of a workflow run's jobs instead of only the first 100, and add an optional `maxPages` trigger metadata to bound repository/job pagination ([#7969](https://github.com/kedacore/keda/issues/7969))
