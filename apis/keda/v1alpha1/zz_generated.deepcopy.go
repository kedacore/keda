...
func (in *AwsSecretManager) DeepCopyInto(out *AwsSecretManager) {
	*out = *in
	...
	if in.Cloud != nil {
		...
		*out = new(AwsSecretMangerCloudInfo)
		**out = **in
	}
}
...
func (in *AwsSecretManagerCredentials) DeepCopyInto(out *AwsSecretManagerCredentials) {
	*out = *in
	...
	out.AccessSecretKey = in.AccessSecretKey
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AwsSecretMangerCloudInfo) DeepCopyInto(out *AwsSecretMangerCloudInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AwsSecretMangerCloudInfo.
func (in *AwsSecretMangerCloudInfo) DeepCopy() *AwsSecretMangerCloudInfo {
	if in == nil {
		return nil
	}
	out := new(AwsSecretMangerCloudInfo)
