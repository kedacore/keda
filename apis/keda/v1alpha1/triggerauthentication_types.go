...
// interface that can handle TriggerAuthentication/ClusterTriggerAuthentication generically
type TriggerAuthenticationStatusHandler interface {
	metav1.Object
	GetScaledObjectNameStr() string
	SetScaledObjectNameStr(str string)
	GetScaledJobNameStr() string
	SetScaledJobNameStr(str string)
}

func (t *TriggerAuthentication) GetScaledObjectNameStr() string {
	return t.Status.ScaledObjectNamesStr
}

func (t *TriggerAuthentication) SetScaledObjectNameStr(str string) {
	t.Status.ScaledObjectNamesStr = str
}

func (t *TriggerAuthentication) GetScaledJobNameStr() string {
	return t.Status.ScaledJobNamesStr
}

func (t *TriggerAuthentication) SetScaledJobNameStr(str string) {
	t.Status.ScaledJobNamesStr = str
}

func (c *ClusterTriggerAuthentication) GetScaledObjectNameStr() string {
	return c.Status.ScaledObjectNamesStr
}

func (c *ClusterTriggerAuthentication) SetScaledObjectNameStr(str string) {
	c.Status.ScaledObjectNamesStr = str
}

func (c *ClusterTriggerAuthentication) GetScaledJobNameStr() string {
	return c.Status.ScaledJobNamesStr
}

func (c *ClusterTriggerAuthentication) SetScaledJobNameStr(str string) {
	c.Status.ScaledJobNamesStr = str
}
