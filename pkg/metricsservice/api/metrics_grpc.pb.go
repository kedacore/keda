...
type MetricsServiceClient interface {
	GetMetrics(ctx context.Context, in *ScaledObjectRef, opts ...grpc.CallOption) (*ExternalMetricValueList, error)
}
...
func (c *metricsServiceClient) GetMetrics(ctx context.Context, in *ScaledObjectRef, opts ...grpc.CallOption) (*ExternalMetricValueList, error) {
...
type MetricsServiceServer interface {
	GetMetrics(context.Context, *ScaledObjectRef) (*ExternalMetricValueList, error)
...
func (UnimplementedMetricsServiceServer) GetMetrics(context.Context, *ScaledObjectRef) (*ExternalMetricValueList, error) {
