...
func TestNewGitHubRunnerScaler_QueueLength_SingleRepo_WithoutScalerDefaultLabels(t *testing.T) {
	var apiStub = apiStubHandler(true, false)
...
func TestNewGitHubRunnerScaler_QueueLength_SingleRepo_WithoutScalerAndJobDefaultLabels(t *testing.T) {
...
func TestNewGitHubRunnerScaler_QueueLength_SingleRepo_WithoutDefaultLabels(t *testing.T) {
	var apiStub = apiStubHandler(true, false)
