...
var parseKafkaMetadataTestDataset = []parseKafkaMetadataTestData{
	...
	{map[string]string{"bootstrapServers": "foobar:9092", "consumerGroup": "my-group", "ensureEvenDistributionOfPartitions": "true"}, true, 1, []string{"foobar:9092"}, "my-group", "", nil, offsetResetPolicy("latest"), false, false, false, true},
	// failure, limitToPartitionsWithLag and ensureEvenDistributionOfPartitions cannot be set to true simultaneously
	{map[string]string{"bootstrapServers": "foobar:9092", "consumerGroup": "my-group", "ensureEvenDistributionOfPartitions": "true", "limitToPartitionsWithLag": "true"}, true, 1, []string{"foobar:9092"}, "my-group", "", nil, offsetResetPolicy("latest"), false, false, true, true},
}
