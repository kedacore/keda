...
func (s *azureMonitorScaler) GetMetricSpecForScaling() []v2beta2.MetricSpec {
	...
	externalMetric := &v2beta2.ExternalMetricSource{
		Metric: v2beta2.MetricIdentifier{
			Name: fmt.Sprintf("%s-%s-%s-%s", "azure-monitor", strings.ReplaceAll(s.metadata.azureMonitorInfo.ResourceURI, "/", "-"), s.metadata.azureMonitorInfo.ResourceGroupName, s.metadata.azureMonitorInfo.Name),
		},
