...
import (
	...
	versioned "github.com/Azure/Kore/pkg/client/clientset/versioned"
	internalinterfaces "github.com/Azure/Kore/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Azure/Kore/pkg/client/listers/kesc/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KescV1alpha1().ScaledObjects(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KescV1alpha1().ScaledObjects(namespace).Watch(options)
			},
		},
		&kescv1alpha1.ScaledObject{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *scaledObjectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kescv1alpha1.ScaledObject{}, f.defaultInformer)
}
