...
type FakeScaledObjects struct {
	Fake *FakeKescV1alpha1
	ns   string
}

var scaledobjectsResource = schema.GroupVersionResource{Group: "kesc.k8s.io", Version: "v1alpha1", Resource: "scaledobjects"}

var scaledobjectsKind = schema.GroupVersionKind{Group: "kesc.k8s.io", Version: "v1alpha1", Kind: "ScaledObject"}
