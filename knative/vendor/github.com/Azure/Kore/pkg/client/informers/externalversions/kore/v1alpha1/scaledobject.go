...
import (
	...
	v1alpha1 "github.com/Azure/Kore/pkg/client/listers/kore/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KoreV1alpha1().ScaledObjects(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KoreV1alpha1().ScaledObjects(namespace).Watch(options)
			},
		},
		&korev1alpha1.ScaledObject{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *scaledObjectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&korev1alpha1.ScaledObject{}, f.defaultInformer)
}
