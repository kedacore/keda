...
import (
	...
	testing_v1alpha1 "github.com/knative/serving/test/apis/testing/v1alpha1"
	versioned "github.com/knative/serving/test/client/clientset/versioned"
	internalinterfaces "github.com/knative/serving/test/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/knative/serving/test/client/listers/testing/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TestingV1alpha1().Builds(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TestingV1alpha1().Builds(namespace).Watch(options)
			},
		},
		&testing_v1alpha1.Build{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *buildInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&testing_v1alpha1.Build{}, f.defaultInformer)
}
