...
func TestScaler(t *testing.T) {
	...
	if giteaURL == "" {
		...
		assert.True(t, WaitForDeploymentReplicaReadyCount(t, kc, deploymentName, testGiteaNamespace, 1, 150, 2),
			"deployment %s should be ready with 1 replica", deploymentName)
