...
const testNamespace = 'rabbitmq-queue-separated-auth-params'
const rabbitmqNamespace = 'rabbitmq-separated-auth-params-test'
...
data:
  ...
  RabbitMqUsername: {{USERNAME_BASE64}}
  RabbitMqPassword: {{PASSWORD_BASE64}}
  RabbitMqDomain: {{DOMAIN_BASE64}}
---
apiVersion: apps/v1
kind: Deployment
metadata:
