...
var (
	...
	buildID                      = os.Getenv("AZURE_DEVOPS_AAD_SP_BUILD_DEFINITION_ID")
	poolName                     = os.Getenv("AZURE_DEVOPS_AAD_SP_POOL_NAME")
...
func TestScaler(t *testing.T) {
	...
	require.NotEmpty(t, buildID, "AZURE_DEVOPS_AAD_SP_BUILD_DEFINITION_ID env variable is required for azure pipelines service principal test")
	require.NotEmpty(t, poolName, "AZURE_DEVOPS_AAD_SP_POOL_NAME env variable is required for azure pipelines service principal test")
