...
package azure_pipelines_license_check_test
...
const (
	testName = "azure-pipelines-license-check-test"
)
...
`
	...
	// licenseCheckScaledObjectTemplate enables the new EnableLicenseCheck
	// feature. It exercises the same scale-out/scale-in flow as the base
	// Azure Pipelines test, but with enableLicenseCheck set to true, to
	// verify that opting into the license check does not break normal
	// scaling behavior end-to-end.
	licenseCheckScaledObjectTemplate = `
...
func TestScaler(t *testing.T) {
	// setup
	t.Log("--- setting up ---")
	require.NotEmpty(t, organizationURL, "AZURE_DEVOPS_ORGANIZATION_URL env variable is required for azure pipelines license check test")
	require.NotEmpty(t, personalAccessToken, "AZURE_DEVOPS_PAT env variable is required for azure pipelines license check test")
	require.NotEmpty(t, project, "AZURE_DEVOPS_PROJECT env variable is required for azure pipelines license check test")
	require.NotEmpty(t, buildID, "AZURE_DEVOPS_BUILD_DEFINITION_ID env variable is required for azure pipelines license check test")
	require.NotEmpty(t, poolName, "AZURE_DEVOPS_POOL_NAME env variable is required for azure pipelines license check test")
	...
	// test scaling with enableLicenseCheck enabled
...
func getTemplateData() (templateData, []Template) {
	...
	return templateData{
			...
			{Name: "licenseCheckScaledObjectTemplate", Config: licenseCheckScaledObjectTemplate},
		}
}
