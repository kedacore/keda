...
package gcp_secret_manager_test
...
const (
	testName = "gcp-secret-manager-test"
)
...
var (
	...
	gcpCredentialsSecretName = fmt.Sprintf("%s-credentials-secret", testName)
	gcpCredentialsSecretKey  = "key.json"
)
