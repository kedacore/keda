...
keda:
  ...
  installKeda: true # If false, the test script will not deploy KEDA during the setup phase.
  installKafka: true # If false, the test script will not deploy Kafka during the setup phase.
  imageRegistry: ""
  imageRepo: ""
```
